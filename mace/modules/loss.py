...
class ChargesSingleLoss(torch.nn.Module):
    def __init__(self, charges_weight=1.0) -> None:
        super().__init__()
        self.register_buffer(
            "charges_weight",
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(" f"charges_weight={self.charges_weight:.3f})"
